...
Table
         coef_flux(K,p)
                      1         2            3
         NO2         0.8146   0.8830     1.081
         PM10        0.2550   0.2577     0.2720
         SO2         0.3520   0.3546     0.3666
         O3          3.3426   3.3967     3.5548
         CO2         98.8     35.4       36.9
         GWater      0.0649   0.0517     0.02406;
Positive variables
...
Equations
        Tree5, Tree13, Tree14, Tree15, Tree16, Tree21, Tree22, Tree23;
...
Tree5..
         Total_area =E= Area_oak + Area_elm + Area_hem;
Tree13..
         SO2_S =E= (Area_elm*coef_flux('SO2','2') + Area_oak*coef_flux('SO2','1') + Area_hem*coef_flux('SO2','3'));
Tree14..
         NO2_S =E= (Area_elm*coef_flux('NO2','2') + Area_oak*coef_flux('NO2','1') + Area_hem*coef_flux('NO2','3'));
Tree15..
         PM10_S =E= (Area_elm*coef_flux('PM10','2') + Area_oak*coef_flux('PM10','1') + Area_hem*coef_flux('PM10','3'));
Tree16..
         O3_S =E= (Area_elm*coef_flux('O3','2') + Area_oak*coef_flux('O3','1') + Area_hem*coef_flux('O3','3'));
Tree21..
        CO2_S =E=(Area_elm*coef_flux('CO2','2') + Area_oak*coef_flux('CO2','1') + Area_hem*coef_flux('CO2','3'));
Tree22..
         groundwater_supply =E= (Area_elm*coef_flux('GWater','2') + Area_oak*coef_flux('GWater','1') + Area_hem*coef_flux('GWater','3'))* 0.00003;
...
CF_4..
         ...
         + 0.425*Amount_alum*365 - (3E-8*(vol_basin_coag*35.3147)**3) + (0.0008*(vol_basin_coag)**2) + (7.8303*vol_basin_coag*35.3147) +
         22588;
...
Cost1..
         Manuf_cost =E= 347608   + Cost_KOH*fc('KOH','Src5','Mix3')*Annual + Cost_MeOH*fc('MeOH','Src3','Mix2')*Annual + Cost_PhosA*fc('PhosA','Src7','Reactor4')*Annual
                          + Cost_Wa*Delta*3600*24*366  + (Fuel)*0.6916 + 10*Cap_CHP*1000 + Cost_Oil*fc('Oil','Src','Mix3')*Annual + oc_CF + oc_Wetland
         + 26.8*(Area_oak)*0.000247105 + 25.6*(Area_elm)*0.000247105 + 30.08*(Area_hem)*0.000247105;
...
Cost4..
         CI =E= FCI  +  1536*1000*Cap_CHP + Total_area*0.000247105*Cost_land  + 57.6*(Area_oak)*0.000247105 + 56.32*(Area_elm)*0.000247105 + 67.84*(Area_hem)*0.000247105 + cc_CF + cc_Wetland;
Cost5..
         Cw =e= 0.15*(FCI + 1536*1000*Cap_CHP);
*Working capital for plant

Cost6..
         Dep =e= (FCI  +  1536*1000*Cap_CHP - 39600)/20;
