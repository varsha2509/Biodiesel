$Title: Biodiesel TES Model - 12/8/2016
$ontext
Modified: 12/8/2016
Changes made: Updated MeOH, Glycerol, Potassium phosphate and water.
Trying out new costs for water with current value: $0.0105 and double the current value.
$offtext
...
*        Running variables for heating and cooling utilities
         v/1*11/
...
*        Flowrate*Cp
         FCP(unit,unit1)          streamflow*heat capacity
...
*         Q_reb(column)   heat load of reboiler of column
         ...
         QSIA(v)          heat sink above pinch candidate
         QSOA(v)         heat source above pinch candidate ;
...
*Steamflow and heat capacity for heat integration calculations
FCP.up(unit,unit1)$Arc(unit,unit1)= 10000;
FCP.lo(unit,unit1)$Arc(unit,unit1)= 0.00001;
...
*Positive Variable
*         Cost_Wa                         Cost of process water;
*Cost_Wa.lo =  0.0005;
*Cost_Wa.up =  0.002;
*Twice the lower bound value
*         Rel_1, Rel_2;
...
Equations
         Feed_1, Feed_2, Admixing_1, Feed_3;
...
Feed_3..
         FCP('Mix3','HX45') =E= fc('Wa','Mix3','HX45')*c_p_ind('Wa') + fc('MeOH','Mix3','HX45')*c_p_ind('MeOH') + fc('KOH','Mix3','HX45')*c_p_ind('KOH') + fc('FFA','Mix3','HX45')*c_p_ind('FFA')  +
                                 fc('Oil','Mix3','HX45')*c_p_ind('Oil');
...
Reactran_12..
               FCP('HX45','Reactor3') =E= fc('Wa','HX45','Reactor3')*c_p_ind('Wa') + fc('MeOH','HX45','Reactor3')*c_p_ind('MeOH') + fc('KOH','HX45','Reactor3')*c_p_ind('KOH')+ fc('Oil','HX45','Reactor3')*c_p_ind('Oil') +
                                                 fc('FFA','HX45','Reactor3')*c_p_ind('FFA');
...
Equations
         ...
         MD_18, MD_19, MD_20, MD_21, MD_23, MD_24, MD_25, MD_26 , HX11_1, HX12_1, MD_27, MD_28, MD_29, MD_30,MD_37, MD_38, MD_39,MD_40, MD_41;
*Scalar
...
MD_39..
         FCP('Reactor3','HX10') =E= fc('Wa','Reactor3','HX10')*c_p_ind('Wa') + fc('KOH','HX10','Col3')*c_p_ind('KOH')  + fc('Glycerol','HX10','Col3')*c_p_ind('Glycerol') +   fc('MeOH','HX10','Col3')*c_p_ind('MeOH');
...
MD_40..
         FCP('Col3','Mix2') =E= fc('MeOH','Col3','Mix2')*c_p_ind('MeOH');

MD_41..
         FCP('Col3','HX13') =E=  fc('Wa','Col3','HX13')*c_p_ind('Wa') + fc('MeOH','Col3','HX13')*c_p_ind('MeOH') + fc('Glycerol','Col3','HX13')*c_p_ind('Glycerol') + fc('KOH','Col3','HX13')*c_p_ind('KOH')
                                 + fc('Oil','Col3','HX13')*c_p_ind('Oil') + fc('FFA','Col3','HX13')*c_p_ind('FFA') + fc('FAME','Col3','HX13')*c_p_ind('FAME');
...
Equations
         ...
         FAME_18, FAME_19, FAME_21, FAME_22, HX20_1, HX21_1, HX23_1, HX22_1, FAME_23, FAME_24, FAME_25;
...
FAME_24..
         FCP('Col5','HX22') =E= fc('FAME','Col5','HX22')*c_p_ind('FAME') + fc('FFA','Col5','HX22')*c_p_ind('FFA') + fc('Oil','Col5','HX22')*c_p_ind('Oil');
FAME_25..
         FCP('Col5','HX23') =E= fc('FAME','Col5','HX23')*c_p_ind('FAME')  + fc('Oil','Col5','HX23')*c_p_ind('Oil');
...
Equations
         ...
         HX17_1, HX18_1, Glydis_27, Glydis_28, Glydis_29, Glydis_30;
...
Glydis_30..
         FCP('Col4','HX18') =E= fc('Wa','Col4','HX18')*c_p_ind('Wa') + fc('MeOH','Col4','HX18')*c_p_ind('MeOH') + fc('Glycerol','Col4','HX18')*c_p_ind('Glycerol');
...
Glydis_29..
         FCP('Col4','HX17') =E= fc('Wa','Col4','HX17')*c_p_ind('Wa') + fc('MeOH','Col4','HX17')*c_p_ind('MeOH') + fc('Glycerol','Col4','HX17')*c_p_ind('Glycerol');
...
*Heatreq1..
*                 QSIA('1') =E= FCP('Reactor3','HX10')*(20) + FCP('Col3','HX13')*((T('Col3','HX13') - 60) - (T('HX10','Col3') - 60)) + FCP('Col4','HX18')*(T('Col4','HX18') - 60) +
*                                 FCP('Col5','HX23')*(0 - 20) +FCP('Mix3','HX45')*(0 - 0);
*** Assumption: I'm assuming that for FCP('Col5','HX23')*(max(0,(T('Col5','HX23') - 60)) - 20) - since use of a max function with a variable makes the problem non-smooth and discountinuous, I'm assuming that
*                max(0,(T('Col5','HX23') - 60)) is zero. In other words, T('Col5','HX23') is always less than 60.
* Once again for FCP('Mix3','HX45') I am assuming tjin which is T('Mix3','HX45') is always less than 60.



*        QSIA('1')     =e= FCP('Reactor3','HX10')*(80-60) + FCP('Col3','HX13')*(T('Col3','HX13') - T('HX10','Col3')) + FCP('Col4','HX18')*(T('Col4','HX18') -60) + FCP('Col5','HX23')*(T('Col5','HX23') - 80) +
*                         FCP('Mix3','HX45')*(60 - T('Mix3','HX45'));
*Heatreq2..
*         QSIA('2)


***** Final: Calculating heat input as sum of all steam consumption utilities.
Heatreq1..
...
Scalar
         ...
         Top_summer      Operating hours in summer /2904/
*Change this to 2991 based on PAR_sun>0 value obtained from weather station data
         Top_winter      Operaitng hours in winter /5880/;
...
Cost1..
         Manuf_cost =E=  347608 + Cost_KOH*fc('KOH','Src5','Mix3')*Annual + Cost_MeOH*fc('MeOH','Src3','Mix2')*Annual + Cost_PhosA*fc('PhosA','Src7','Reactor4')*Annual
...
Cost5..
         Cw =E= 0.15*CI;
*Working capital is 15% of Total capital investment
...
Cost7..
         NPV =E= (-(CI + Cw) + (((Revenue - Manuf_cost)*(1-tax))*(1 - (1.07)**(-20)))/0.07 + (Dep*tax)*(1 - (1.07)**(-20))/0.07 + Cw/(1.07)**20)/20;
